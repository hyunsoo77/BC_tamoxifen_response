...
suppressMessages(suppressWarnings(library(conflicted))) # for checking conflicted libraries


conflict_prefer("margin", "ggplot2", quiet=TRUE)

conflict_prefer("unname", "base", quiet=TRUE)
conflict_prefer("setdiff", "base", quiet=TRUE)
conflict_prefer("union", "base", quiet=TRUE)
